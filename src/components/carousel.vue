  ...
  <div id="titleCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="https://picsum.photos/2" class="d-block w-100" alt="Slide 1">
        <div class="carousel-caption d-none d-md-block">
          <h1 class="text-white"> {{olympic_title_en}} </h1>
        </div>
      </div>
      <div class="carousel-item">
        <img src="https://picsum.photos/1" class="d-block w-100" alt="Slide 2">
        <div class="carousel-caption d-none d-md-block">
          <h1 class="text-white"> {{olympic_title_tw}}  </h1>
        </div>
      </div>
      <div class="carousel-item">
        <img src="https://picsum.photos/3" class="d-block w-100" alt="Slide 3">
        <div class="carousel-caption d-none d-md-block">
          <h1 class="text-white"> {{olympic_title_tw}}  </h1>
        </div>
      </div>
...
export default {
  data() {
    return {
      olympic_title_en: 'Paris Olympic 2024',
      olympic_title_tw: '巴黎奧運- 2024'
    }
  },
};
</script>
